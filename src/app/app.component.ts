...
@Component({
  ...
  imports: [RouterOutlet, NavbarComponent, FooterComponent, TodoListComponent,TodoCardDetailsComponent,RouterModule], // bu component angularda diğer özelliklerin hangilerini import ediyor?
